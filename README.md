...
A global e-commerce company founded in 2018 specializes in selling popular electronics like Apple, Samsung, and ThinkPad products. This case study is framed in collaboration with operations leadership to extract insights and deliver recommendations to improve performance across sales, product, and marketing teams.

## Executive Summary

Sales analysis of 108k records across 2019-2022 shows annual revenue stabilizing at around $7 million, nearing pre-COVID levels, with North America and EMEA contributing 80% of sales. Monitors and AirPods account for 60% of revenue, though customer retention is a concern as unique and repeat purchase rates have declined by 15% and 10%, respectively. The business can benefit from expanding top product lines, optimizing bundling, and enhancing loyalty programs to increase customer lifetime value. Targeted growth in APAC and LATAM, along with improvements to digital channels like the mobile app, will strengthen market position and drive sustainable growth.

![E-Commerce Dataset ERD](Data/visualizations/ecommerce_ERD.webp)
E-Commerce Dataset ERD

## Insights Deep-Dive

### Sales Trends and Growth Rates

- The business averages $7 million in annual sales with 27,000 orders per year.
...
- The business shows seasonality, with peak sales in November and December and lower sales in February and October.
...
- Unique customers grew steadily from 2019 to 2021, peaking at nearly 30,000 in 2021, but declined sharply by nearly 40% in 2022.
...
- Direct channel accounts for 83% ($23M) of sales.
...
- In 2021, refunds decreased across all products compared to the previous two years.
